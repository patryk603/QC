...
public class LotBiletyAllSelectPlacesFF extends MainTest{
    ...
    public void Test_BuyTicketsEU(String localization, String from, String to, XSSFCell departuredata, XSSFCell returndata) throws Exception {
        ...
        try {
           ...
           System.out.println("Nie mozna wybrac miajsca siedzenia do celu : "+ e.getMessage());
        }
        ...
        try {
            ...
            System.out.println("Nie mozna wybrac miajsca siedzenia powrotnego : "+ e.getMessage());
        }
