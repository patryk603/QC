...
public class LotBiletyEUMorePersons extends MainTest{
    ...
    public void Test_BuyTickets(String localization, String from, String to, XSSFCell departuredata, XSSFCell returndata, int passangers) throws Exception {
        ...
        */
        ...
        //Selecting Passangers
        try {
            HomePage.Passengers.click();
            HomePage.Adults.click();
            Select adults = new Select(HomePage.Adults);
            adults.selectByIndex(passangers);

        } catch (Exception e) {
            System.out.println("Cannot select Passangers : "+ e.getMessage());
        }
    ...
    public Object[][] passData()
    {
        ...
        for(int i=0;i<rows;i++){
            ...
            data[i][5]=config.getNumber(0,i,5);
        }
        return data;
    }
    //Excel configuration
